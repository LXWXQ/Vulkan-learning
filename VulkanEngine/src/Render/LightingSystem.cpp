...
LightingSystem::LightingSystem(Device& device, VkRenderPass renderPass, VkDescriptorSetLayout globalSetLayout)
    : vulkanDevice(device) 
{
...
void LightingSystem::createPipeline(VkRenderPass renderPass) 
{
    ...
    lightingPipeline = std::make_unique<Pipeline>(vulkanDevice, "../shaders/lighting.vert.spv", "../shaders/lighting.frag.spv", config);
